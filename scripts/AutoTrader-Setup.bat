...
echo    설치가 끝났습니다!
echo.
echo    바탕화면에 바로가기 두 개가 생겼습니다.
echo      - "AutoTrader 백테스트"      : 지금 바로 실행해 볼 수 있습니다.
echo      - "AutoTrader 모의투자 시작" : 아래 준비 후 장중에 실행하세요.
echo.
echo    [모의투자 실행 전 준비 - 최초 1회]
echo      1. openapi.kiwoom.com 접속, 키움 REST API 사용 신청
echo      2. 모의투자 신청 후 모의투자용 appkey/secretkey 발급
echo      3. 잠시 후 열리는 config.ini에 두 키를 붙여넣고 저장
echo.
